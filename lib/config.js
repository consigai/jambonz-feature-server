...
// Split-SBC deployments: set to "1" so an inbound call's outbound dial/transfer
// leg uses getSBC() (the outbound SBC pool) instead of reusing the ingress SBC.
// Default (unset) keeps upstream behavior (reuse the ingress SBC, i.e. the
// static-IP feature) for single-SBC deployments. Must be ON wherever sbc-inbound
// can't route outbound, or inbound-call dial legs 480. (consigai/jambonz-feature-server #777)
const JAMBONES_DIAL_USE_OUTBOUND_SBC = process.env.JAMBONES_DIAL_USE_OUTBOUND_SBC || false;
...
module.exports = {
  ...
  JAMBONES_LOGLEVEL,
  JAMBONES_CLUSTER_ID,
  // SBC Health Check Configuration
  SBC_MAX_FAILED_PINGS: process.env.SBC_MAX_FAILED_PINGS || '3',
  SBC_HEALTH_CHECK_ENABLED: process.env.SBC_HEALTH_CHECK_ENABLED !== 'false',
  SBC_PING_TIMEOUT_MS: process.env.SBC_PING_TIMEOUT_MS || '5000',
  PORT,
  HTTP_PORT_MAX,
  HTTP_IP,
  K8S,
  ...
  JAMBONES_DIAL_USE_OUTBOUND_SBC,
